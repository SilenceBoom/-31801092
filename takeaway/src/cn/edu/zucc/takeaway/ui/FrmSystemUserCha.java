...
public class FrmSystemUserCha extends JDialog implements ActionListener{
	...
	public FrmSystemUserCha(Frame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnCancel)
			...
			try {
				TakeAwayUtil.systemManager.changepwd(BeanSystemUser.currentLoginUser,new String(edtPwdOld.getPassword()),new String(edtPwd.getPassword()),new String(edtPwd2.getPassword()));
				this.setVisible(false);
